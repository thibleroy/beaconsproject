...
router.get('/', async (request: Request, response: Response) => {
    ...
    const ClientMsg: ClientMessage = {
        type: ENV.kafka_request,
        action: ENV.kafka_action_list,
        value: undefined,
        id: id,
        status: 0
    };
...
router.post('/', async (request: Request, response: Response) => {
    ...
    const ClientMsg: ClientMessage = {
        type: ENV.kafka_request,
        action: ENV.kafka_action_create,
        value: currentClient,
        id: id,
        status: 0
    };
...
router.get('/:clientId', async (request: Request, response: Response) => {
    ...
    const ClientMsg: ClientMessage = {
        type: ENV.kafka_request,
        action: ENV.kafka_action_read,
        value: {id_client: request.params.clientId},
        id: id,
        status: 0
    };
...
router.delete('/:clientId', async (request: Request, response: Response) => {
    ...
    const ClientMsg: ClientMessage = {
        type: ENV.kafka_request,
        action: ENV.kafka_action_delete,
        value: {id_client: request.params.clientId},
        id: id,
        status: 0
    };
...
router.put('/:clientId', async (request: Request, response: Response) => {
    ...
    const ClientMsg: ClientMessage = {
        type: ENV.kafka_request,
        action: ENV.kafka_action_update,
        value: currentClient,
        id: id,
        status: 0
    };
...
router.get('/:clientId/beacons/:beaconId', async (request: Request, response: Response) => {
    ...
    const beaconMsg: BeaconMessage = {
        type: ENV.kafka_request,
        action: ENV.kafka_action_read,
        value: {id_client: request.params.clientId, id_beacon: request.params.beaconId},
        id: id,
        status: 0
    };
...
router.get('/:clientId/beacons/:beaconId/contents/:contentId', async (request: Request, response: Response) => {
    ...
    const contentMsg: ContentMessage = {
        ...
        action: ENV.kafka_action_read,
        value: {
            id_client: request.params.clientId,
            id_beacon: request.params.beaconId,
            id_content: request.params.contentId
        },
        id: id,
        status: 0
    };
...
const authConsumer = new kafka.Consumer(kafkaClient, tPartitions, consumerOptions);
